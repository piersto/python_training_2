...
class ContactHelper:
    ...
    def get_contact_list(self):
        if self.contact_cache is None:
            ...
            for element in wd.find_elements_by_name("entry"):
                ...
                self.contact_cache.append(Contact(lastname=lastname, first_name=first_name, id=id, all_phones_from_home_page=all_phones, all_mails_from_home_page=all_mails))
    ...
    def get_contact_info_from_edit_page(self, index):
        ...
        return Contact(first_name=first_name, lastname=lastname, middlename=middlename, id=id,
                       ...
                       email=email, second_email=second_email, third_email=third_email)
